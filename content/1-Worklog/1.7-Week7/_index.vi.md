...
* Xây dựng cấu trúc dự án và môi trường phát triển.
* Hoàn thành các chức năng nền tảng của hệ thống.
* Áp dụng các kiến thức AWS đã học vào quá trình phát triển.
...
* Hoàn thành việc khởi tạo dự án và cấu hình môi trường phát triển.

* Thiết lập GitHub Repository và thống nhất quy trình làm việc giữa các thành viên.

* Hoàn thành cấu hình Docker, Docker Compose và kết nối thành công với cơ sở dữ liệu.

* Xây dựng các chức năng nền tảng của hệ thống:
  * Quản lý sách
  * Quản lý thể loại
  * Quản lý độc giả

* Kiểm thử thành công các API cơ bản và xác nhận dữ liệu được lưu trữ chính xác.

* Hoàn thành Sprint đầu tiên và xác định các công việc cần thực hiện trong giai đoạn hoàn thiện hệ thống.