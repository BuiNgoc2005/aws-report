...
* Learn the fundamental concepts of Cloud Computing and Amazon Web Services (AWS).
* Complete the basic hands-on labs in Module 01.
* Form a team and begin discussing the direction for the internship project.
...
* Gained an understanding of AWS Global Infrastructure and the core AWS service categories, including:
  * Compute
  * Storage
  * Networking
  * Database
...
* Completed the first team meeting, established the team's working approach, and agreed on the communication process throughout the internship.

* Proposed and analyzed several project ideas as the foundation for selecting a project topic and preparing the Proposal in the following week.